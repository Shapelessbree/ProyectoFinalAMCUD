...
export const ShortTextInput = ({
  ...
  props.maxLength = props.maxLength ?? 60;
  props.minLength = props.minLength ?? 10;
...
export const LongTextInput = ({
  ...
  props.maxLength = props.maxLength ?? 4000;
  props.minLength = props.minLength ?? 100;
  const length = watch(props.name!) ? watch(props.name!).length : 0;
  props.placeholder = customProps.disabledText ? "" : props.placeholder;
